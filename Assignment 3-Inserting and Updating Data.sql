...
*/
 INSERT INTO employees (firstName, lastName, Title, dateOfBirth, hireDate)
 VALUES ('Trayshawn', 'Seamster', 'Software Developer', ADDDATE, '2002-02-20', '2022-09-06');
...
*/
  ...
  WHERE name = 'Trayshawn Seamster' AND title = 'Software Develop';
